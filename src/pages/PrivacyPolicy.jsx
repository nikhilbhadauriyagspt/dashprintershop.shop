...
export default function PrivacyPolicy() {
  return (
   ...
   ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:      </p>
      <ul>
        <li>Visit our website at <a href="https://dashprintershop.shop/">https://dashprintershop.shop/</a> or any website of ours that links to this Privacy Notice</li>
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>        <li>Engage with us in other related ways, including any marketing or events</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://dashprintershop.shop/cookie-policy">https://dashprintershop.shop/cookie-policy</a>.</p>
      ...
      <h3>How to Exercise Your Rights</h3>
             <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at info@dashprintershop.shop, by visiting <a href="https://dashprintershop.shop/contact">https://dashprintershop.shop/contact</a>, or by referring to the contact details at the bottom of this document.</p>      <p>Under certain US state data protection laws, you can designate an authorized agent to make a request on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with applicable laws.</p>
